<footer>
    <div class="flex flex-wrap gap-6 py-10 mt-10 justify-between items-start text-center bg-[#1C5B8F] font-semibold">
        ...
        <div class="flex-1 justify-center min-w-[300px] space-y-10">
            ...
            <a href="/front/services/menu_activity.php" class="footer-text">Activités</a><br>
            <a href="/front/account/planification.php" class="footer-text">Planning</a><br>
        ...
        <div class="flex-1 justify-center min-w-[300px]">
            <div class="text-white text-xl">© 2026 Silver Happy. Tous droits réservés.
