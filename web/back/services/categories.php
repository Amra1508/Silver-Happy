                ...
                categories.forEach(c => {
                    ...
                    <tr class="hover:bg-gray-50 transition border-b">
                        ...
                        <td class="p-4 flex justify-center gap-4">
                            <button onclick="openEditModal(${id}, '${nom.replace(/'/g, "\\'")}')" class="text-[#E1AB2B] bg-[#E1AB2B]/10 hover:bg-[#E1AB2B]/20 px-3 py-1 rounded-lg font-bold text-sm">Modifier</button>
