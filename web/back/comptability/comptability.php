...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="w-64 bg-[#1C5B8F] text-white flex flex-col hidden md:flex shadow-xl z-20 shrink-0">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="#" class="block px-4 py-3 bg-white/10 rounded-xl font-bold flex items-center gap-3">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 17v-2a4 4 0 014-4h2a4 4 0 014 4v2m-3-9a3 3 0 11-6 0 3 3 0 016 0zM1 21h22"></path></svg>
    ...
    <script>
        const formatCurrency = (amount) => parseFloat(amount).toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' });
